...
import logo from '../../../public/images/logotipe.png';
import './NavMenu.css';
                    ...
                    <div className="header__middle__menus">
                        ...
                        <nav className="main-nav " >
                            ...
                            <ul className={boxClass.join(' ')}>
                                ...
                                <li className="menu-item " >
                                    <NavLink onClick={toggleClass} activeClassName='is-active' to={`/About`}> About </NavLink>
                                </li>
                                <li onClick={toggleSubmenu} className="menu-item sub__menus__arrows" >
                                    <Link to="#"> Shop <FiChevronDown /> </Link>
                                    <ul className={boxClassSubMenu.join(' ')} >
                                        <li>
                                            <NavLink onClick={toggleClass} activeClassName='is-active' to={`/Online`}> Online Shop </NavLink>
                                        </li>
